...
const TicketModal: React.FC<TicketModalProps> = ({ isOpen, onClose, mode, ticket }) => {
  ...
  useEffect(() => {
    if (mode === 'edit' && ticket) {
      ...
      setFormData({ title: '', description: '', type: 'support', status: 'open', priority: 'medium', companyId: '', dueDate: '' });
    }
  }, [mode, ticket]);
